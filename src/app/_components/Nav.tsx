...
export const Nav: React.FC = () => {
  return (
    <div className="flex w-[80%] bg-white rounded-[15px]">
      ...
      <Link href="/calendar" className="flex flex-col items-center justify-center p-4 text-textColor flex-1">
        <Image src="/calendar.png" alt="入力ボタン" width={30} height={30} className="mb-2" />
        カレンダー
      </Link>
      <Link href="/graph" className="flex flex-col items-center justify-center p-4 text-textColor flex-1">
        <Image src="/graph.png" alt="入力ボタン" width={30} height={30} className="mb-2" />
        グラフ
      </Link>
      <Link href="/settings" className="flex flex-col items-center justify-center p-4 text-textColor flex-1">
